...
HMR.scrollForm = function() {
    ...
    $("a.scroll[href*=#]").each(function() {
        var d = a(this.pathname) || b;
        if (b == d && (location.hostname == this.hostname || !this.hostname) && this.hash.replace(/#/, "")) {
            var e = $(this.hash), f = this.hash;
            if (f) {
                var g = e.offset().top;
...
(function() {
    HMR.homepageImageViewer = function() {
        ...
        var c = $.backstretch(b, a);
        var d = $("body").data("backstretch");
...
(function() {
    HMR.portfolioGallery = function() {
        ...
        var a = $(".slide_thumb"), b = $(".big_arrow"), c = $(".thumb_nav"), d = $(".venue"), e = $(".photographer a"), f = $(".photographer"), g = -1, h = a.length, i, j, k, l, m, n;
        var o = $(c).bxSlider({
            pager: false,
            minSlides: 12,
            maxSlides: 12,
        ...
        j = function(a) {
            $(".id-" + a).transition({
                opacity: 1
            }, 750, "ease").addClass("show");
            $(".idVenue-" + a).transition({
                opacity: 1
            }, 750, "ease");
            $(".url-" + a).transition({
                opacity: 1
