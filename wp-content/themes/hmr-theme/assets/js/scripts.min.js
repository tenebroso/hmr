...
(function() {
    HMR.homepageImageViewer = function() {
        var a = [ {
            img: "/assets/home/homeSlide1.jpg",
            words: ".slide1"
        }, {
            img: "/assets/home/homeSlide2.jpg",
            words: ".slide2"
        }, {
            img: "/assets/home/homeSlide3.jpg",
            words: ".slide3"
        }, {
            img: "/assets/home/homeSlide4.jpg",
            words: ".slide4"
        }, {
            img: "/assets/home/homeSlide5.jpg",
            words: ".slide5"
        }, {
            img: "/assets/home/homeSlide6.jpg",
            words: ".slide6"
        }, {
            img: "/assets/home/homeSlide7.jpg",
            words: ".slide7"
        }, {
            img: "/assets/home/homeSlide8.jpg",
            words: ".slide8"
        } ];
        var b = {
            fade: 1550,
        ...
        var d = $.backstretch(c, b);
        var e = $("body").data("backstretch");
        $(window).on("backstretch.show", function(b, c) {
            var d = a[c.index].words;
            $(d).transition({
                opacity: 1
            }, 1550);
        });
...
(function() {
    HMR.teamSlide = function() {
        jQuery.fn.animateAuto = function(a, b, c) {
            var d, e, f;
            return this.each(function(g, h) {
                h = jQuery(h), d = h.clone().css({
                    height: "auto",
                    width: "auto"
                }).appendTo("body");
                e = d.css("height"), f = d.css("width"), d.remove();
                if (a === "height") h.animate({
                    height: e
                }, b, c); else if (a === "width") h.animate({
                    width: f
                }, b, c); else if (a === "both") h.animate({
                    width: f,
                    height: e
                }, b, c);
            });
        ...
        $team = $("#team"), $hero = $("#team-photo"), $members = $("#team-members"), windowSize = $(window).width();
