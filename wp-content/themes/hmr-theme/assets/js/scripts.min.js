...
})}}();var HMR=HMR||{};!function(){HMR.teamArchiveFaceMap=function(){$(".hastip").tooltipsy({alignTo:"element",offset:[0,1],content:'<h4 class="caps">Bob Mertzlufft</h4><p><em>President</em></p>',show:function(a,b){b.slideDown(300)}})}}();var HMR=window.HMR||{};HMR.Site={common:{init:function(){function a(){window.location=linkLocation}$("#s").clearField(),$("body").show(),$("a").click(function(b){b.preventDefault(),linkLocation=this.href,$("body").fadeOut(500,a)})},finalize:function(){}},home:{init:function(){HMR.homepageImageViewer()}},about:{init:function(){}},archive:{init:function(){$("article.span2:nth-child(6n+7)").addClass("clear"),HMR.teamArchiveFaceMap()}}};var UTIL={fire:function(a,b,c){var d=HMR.Site;b=void 0===b?"init":b,""!==a&&d[a]&&"function"==typeof d[a][b]&&d[a][b](c)},loadEvents:function(){UTIL.fire("common"),$.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(a,b){UTIL.fire(b)}),UTIL.fire("common","finalize")}};$(document).ready(UTIL.loadEvents);