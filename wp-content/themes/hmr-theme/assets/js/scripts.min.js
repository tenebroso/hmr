...
(function() {
    HMR.portfolioGallery = function() {
        ...
        var a = $(".slide_thumb"), b = $(".big_arrow"), c = $(".thumb_nav"), d = $(".photographer"), e = -1, f = a.length, g, h, i, j, k;
        $(c).bxSlider({
            pager: false,
            minSlides: 12,
            maxSlides: 12,
    ...
    common: {
        init: function() {
            ...
            $(".scrollTop a, .post-type-archive-team a, .back a").click(function(a) {
                var c = a.which === 115 || a.ctrlKey || a.metaKey || a.which === 19;
                if (!c) {
