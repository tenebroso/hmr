...
!function(a) {
    ...
    a.fn.alert = function(b) {
        return this.each(function() {
            ...
            if (!e) d.data("alert", e = new c(this));
...
!function(a) {
    ...
    a.fn.button = function(c) {
        return this.each(function() {
            ...
            if (!e) d.data("button", e = new b(this, f));
...
!function(a) {
    ...
    b.prototype = {
        ...
        to: function(b) {
            ...
            return this.slide(b > c ? "next" : "prev", a(this.$items[b]));
        },
        pause: function(b) {
            if (!b) this.paused = true;
    ...
    a.fn.carousel = function(c) {
        return this.each(function() {
            ...
            if (!e) d.data("carousel", e = new b(this, f));
...
!function(a) {
    ...
    a.fn.scrollspy = function(c) {
        return this.each(function() {
            ...
            if (!e) d.data("scrollspy", e = new b(this, f));
            if (typeof c == "string") e[c]();
        });
    };
...
(function(a, b, c) {
    ...
    a.fn.backstretch = function(d, f) {
        return (d === c || d.length === 0) && a.error("No images were supplied for Backstretch"), 
        a(b).scrollTop() === 0 && b.scrollTo(0, 0), this.each(function() {
            var b = a(this), c = b.data("backstretch");
            c && (f = a.extend(c.options, f), c.destroy(!0)), c = new e(this, d, f), b.data("backstretch", c);
        });
    ...
    var d = {
        ...
        this.options = a.extend({}, a.fn.backstretch.defaults, g || {}), this.images = a.isArray(e) ? e : [ e ], 
        a.each(this.images, function() {
            a("<img />")[0].src = this;
        }), this.isBody = c === document.body, this.$container = a(c), this.$wrap = a('<div class="backstretch"></div>').css(d.wrap).appendTo(this.$container), 
        this.$root = this.isBody ? f ? a(b) : a(document) : this.$container;
        if (!this.isBody) {
            var h = this.$container.css("position"), i = this.$container.css("zIndex");
            this.$container.css({
                position: h === "static" ? "relative" : h,
                zIndex: i === "auto" ? 0 : i,
                background: "none"
            }), this.$wrap.css({
                zIndex: -999998
        ...
        this.$wrap.css({
            ...
            this.isBody && b.pageYOffset === 0 && (b.scrollTo(0, 1), this.resize());
        }, this));
    };
    e.prototype = {
        resize: function() {
        ...
        show: function(b) {
            if (Math.abs(b) > this.images.length - 1) return;
            this.index = b;
            var c = this, e = c.$wrap.find("img").addClass("deleteable"), f = a.Event("backstretch.show", {
                relatedTarget: c.$container[0]
            });
            return clearInterval(c.interval), c.$img = a("<img />").css(d.img).bind("load", function(b) {
                var d = this.width || a(b.target).width(), g = this.height || a(b.target).height();
                a(this).data("ratio", d / g), a(this).fadeIn(c.options.speed || c.options.fade, function() {
                    e.remove(), c.paused || c.cycle(), c.$container.trigger(f, c);
                }), c.resize();
    ...
    var f = function() {
        ...
        return !((c.indexOf("iPhone") > -1 || c.indexOf("iPad") > -1 || c.indexOf("iPod") > -1) && e && e < 534 || b.operamini && {}.toString.call(b.operamini) === "[object OperaMini]" || h && i < 7458 || a.indexOf("Android") > -1 && e && e < 533 || g && g < 6 || "palmGetResource" in b && e && e < 534 || a.indexOf("MeeGo") > -1 && a.indexOf("NokiaBrowser/8.5.0") > -1 || k && k <= 6);
    }();
})(jQuery, window);
...
(function() {
    HMR.sidebarPadding = function() {
        var a = $(".post:first-of-type header");
        $(".sidebar").css({
            paddingTop: a.height()
        });
    };
...
HMR.MapTest = function() {
    var a = document.getElementById("map_nest"), b = [ {
        ...
        lat: 41.904135,
        lng: -87.65613
    }, d = new google.maps.LatLng(c.lat, c.lng), e = new google.maps.LatLng(41.904366, -87.662659), f = {
        zoom: 16,
        styles: b,
    ...
    }, g = new google.maps.Map(a, f), h = new google.maps.Marker({
        flat: true,
...
(function() {
    HMR.pageFading = function() {
        $("body").show();
        $(".scrollTop a, .post-type-archive-team a, .back a").click(function(b) {
            var c = b.which === 115 || b.ctrlKey || b.metaKey || b.which === 19;
            if (!c) {
...
(function() {
    HMR.homepageImageViewer = function() {
        var a = "/assets/CORPORATE-8.jpg";
        $("body").backstretch([ a ]);
        var b = $("body").data("backstretch");
        b.resize();
        if ($(window).width() > 767) {
            $(".forward").transition({
                delay: 1500,
...
(function() {
    HMR.portfolioGallery = function() {
        ...
        var a = $(".slide_thumb"), b = $(".big_arrow"), c = $(".thumb_nav"), d = $(".photographer"), e = -1, f = a.length, g, h, i, j, k, l;
        var m = $(c).bxSlider({
            pager: false,
            minSlides: 12,
            maxSlides: 12,
...
(function() {
    HMR.teamArchiveFaceMap = function() {
        ...
        }, b = '<h4 class="caps"><a href="{{url}}">{{name}}</a></h4><p><em>{{title}}</em></p>', c = Handlebars.compile(b), d;
        d = function() {
            _.each(a.people, function(b) {
                $(b.el).tooltipsy({
                    alignTo: a.settings.element,
                    offset: [ 0, 1 ],
                    content: c(b),
                    show: function(a, b) {
                        b.css({
                            top: parseInt(b[0].style.top.replace(/[a-z]/g, "")) - 30 + "px",
                            opacity: "0.0",
                            display: "block"
                        }).animate({
                            top: parseInt(b[0].style.top.replace(/[a-z]/g, "")) + 30 + "px",
