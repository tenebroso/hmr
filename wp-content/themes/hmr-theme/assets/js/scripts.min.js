...
(function() {
    ...
    HMR.portfolioGallery = function() {
        ...
        var a = $(".slide_thumb"), c = $(".big_arrow"), d = $(".thumb_nav"), e = $(".venue"), f = $(".photographer a"), g = $(".photographer"), h = -1, i = a.length, j, k, l, m, n, o;
        var p = d.bxSlider({
            pager: false,
            minSlides: 12,
            maxSlides: 12,
...
HMR.Site = {
    ...
    about: {
        init: function() {
            ...
            if (a >= 768) {
                $("html").css("background", "none");
                var b = "/assets/history-bg.jpg";
                $("body").backstretch([ b ], {
                    centeredX: false
                });
                var c = $("body").data("backstretch");
                c.resize();
            }
        }
    }
