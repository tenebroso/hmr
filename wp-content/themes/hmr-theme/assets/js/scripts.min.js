...
(function() {
    HMR.sidebarPadding = function() {
        var a = $(".post:first-of-type header"), b = $(".sidebar");
        b.css({
            paddingTop: a.height()
        });
        if (!!$(".sticky").offset()) {
            var c = $(".sticky").offset().top;
...
(function() {
    HMR.teamSlide = function() {
        var a = $(".btn"), b = $(".active.menu-team a");
        $team = $("#team"), $hero = $("#team-photo"), $members = $("#team-members");
        if ($(window).width() > 767) {
            a.on("click", function() {
                $hero.transition({
                    y: "-663px"
