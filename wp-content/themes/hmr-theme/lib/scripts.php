...
function roots_scripts() {
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '75f6e4a7a2df15e4f807e7a58484a879');
  ...
  if (!is_admin() && is_page_template('template-connect.php')) {
    wp_register_script('google_maps', '//maps.google.com/maps/api/js?sensor=false', false, null, false);
    wp_enqueue_script('google_maps');
  }

  wp_register_script('modernizr', get_template_directory_uri() . '/assets/js/vendor/modernizr-2.6.2.min.js', false, null, false);
  wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', false, 'fee853f5d4860cf36a6c6015ea6f5e27', true);
