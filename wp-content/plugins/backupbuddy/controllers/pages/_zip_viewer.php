...
_e( 'Directories may be expanded and text files may be viewed by clicking them.  Check boxes to the left of files or directories to restore and click "Restore Selected" to proceed.', 'it-l10n-backupbuddy' );
