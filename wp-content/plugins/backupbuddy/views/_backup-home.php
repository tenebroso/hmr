...
<div class="duo-button">
	...
	if ( false === $pb_backupbuddy_directory_verification ) {
		...
		foreach( pb_backupbuddy::$options['profiles'] as $profile_id => $profile ) {
			...
			?>
			<a class="pb_backupbuddy_backuplaunch leftright" title="Create this backup" href="<?php echo pb_backupbuddy::page_url(); ?>&backupbuddy_backup=<?php echo $profile_id; ?>"><?php echo htmlentities( $profile['title'] ); ?></a>
			<?php
		}
	}
	?>
